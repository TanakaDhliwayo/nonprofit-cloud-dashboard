            ...
            <div className="card mb-4" style={{ maxWidth: "400px" }}>
              <div className="row g-0">
                <div className="col-md-4">
                  <img
                    src="src/media/Tanaka.jpg" // Replace with actual profile/org image
                    alt="Tanaka Dhliwayo"
          ...
          <div className="col-md-4 mb-4">
            <div className="card" style={{ width: "18rem" }}>
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  Explore AI tools like Microsoft Copilot to boost productivity
          ...
          <div className="col-md-4 mb-4">
            <div className="card" style={{ width: "18rem" }}>
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  Connect and automate systems with Flowgear workflows and API
                  logic—no-code/low-code power.
                </p>
                <a href="#" className="btn btn-primary">
                  Explore Flowgear
                </a>
        ...
        <div className="mt-5">
          ...
          <div className="card">
            <div className="card-body text-center">
              ...
              <p className="card-text">
                Monthly cloud spend analysis to optimize resources and costs.
              </p>
              <AnalyticsChart />
            </div>
          </div>
            ...
            <div className="card-body">
              <ul className="list-group list-group-flush">
                <li className="list-group-item d-flex justify-content-between align-items-center">
                  ...
                  <span className="badge bg-primary rounded-pill">May 23</span>
                </li>
                <li className="list-group-item d-flex justify-content-between align-items-center">
                ...
                <li className="list-group-item d-flex justify-content-between align-items-center">
                  ...
                  <span className="badge bg-success rounded-pill">June 1</span>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div className="row g-0">
              ...
              <div className="col-md-8">
                <div className="card-body">
                  <h5 className="card-title">Tanie Codes Org</h5>
                  <p className="card-text">
                    Empowering girls in township communities with digital and
                    coding skills for the future.
                  </p>
                  <p className="card-text">
                    <small className="text-muted">Lead: Tanaka Dhliwayo</small>
                  </p>
                  <a href="#" className="btn btn-outline-primary btn-sm">
                    Settings
                  </a>
